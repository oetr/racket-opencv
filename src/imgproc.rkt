...
(module core racket
  ...
  (defimgproc cvMorphologyEx
    (_fun _pointer _pointer _pointer _pointer _int _int -> _void))

  #| Calculates all spatial and central moments up to the 3rd order |#
  (defimgproc cvMoments
    (_fun _pointer _pointer _pointer _int -> _void))

  #| Retrieve particular spatial, central or normalized central moments |#
  (defimgproc cvGetSpatialMoment
    (_fun _pointer _int _int -> _double))
  (defimgproc cvGetCentralMoment
    (_fun _pointer _int _int -> _double))
  (defimgproc cvGetNormalizedCentralMoment
    (_fun _pointer _int _int -> _double))

  #| Calculates 7 Hu's invariants from precalculated
  spatial and central moments |#
  (defimgproc cvGetHuMoments
    (_fun _pointer _pointer -> _void))
  ...
  (defimgproc cvGetQuadrangleSubPix
    (_fun _pointer _pointer _pointer -> _void))

  #| Measures similarity between template and overlapped windows in the source image
  and fills the resultant image with the measurements |#
  (defimgproc cvMatchTemplate
    (_fun _pointer _pointer _pointer _int -> _void))

  #| Computes earth mover distance between
  two weighted point sets (called signatures) |#
  (defimgproc cvCalcEMD2
  ...
  *                              Planar subdivisions        *
  ...
  ;; Not available in version 2.4.0
  ;; (defimgproc cvInitSubdivDelaunay2D
  ;;   (_fun  _pointer _CvRect -> _void))

  #| Creates new subdivision |#
  ;; Not available in version 2.4.0
  ;; (defimgproc cvCreateSubdiv2D
  ;;   (_fun _int  _int _int _int _pointer -> _pointer))

  #|************************ high-level subdivision functions ************|#

  #| Simplified Delaunay diagram creation |#
  ;; (defimgproc cvCreateSubdivDelaunay2D
  ...
  ;; Not available in version 2.4.0
  ;; (defimgproc cvSubdivDelaunay2DInsert
  ...
  ;; Not available in version 2.4.0
  ;; (defimgproc cvSubdiv2DLocate
  ;;   (_fun _pointer _CvPoint2D32f _pointer _pointer  -> _CvSubdiv2DPointLocation))

  #| Calculates Voronoi tesselation (i.e. coordinates of Voronoi points) |#
  ;; Not available in version 2.4.0
  ;; (defimgproc cvCalcSubdivVoronoi2D
  ;;   (_fun _pointer  -> _void))

  #| Removes all Voronoi points from the tesselation |#
  ;; Not available in version 2.4.0
  ;; (defimgproc cvClearSubdivVoronoi2D
  ;;   (_fun _pointer  -> _void))

  #| Finds the nearest to the given point vertex in subdivision. |#
  ;; Not available in version 2.4.0
  ;; (defimgproc cvFindNearestPoint2D
  ;;   (_fun _pointer _CvPoint2D32f  -> _pointer))
  ...
  *                                  Histogram functions                     *
  ...
  (defimgproc cvCreateHist
    (_fun _int _pointer _int _pointer _int -> _pointer))

  #| Assignes histogram bin ranges |#
  (defimgproc cvSetHistBinRanges
    (_fun _pointer _pointer _int -> _void))

  #| Creates histogram header for array |#
  (defimgproc cvMakeHistHeaderForArray
    (_fun _int _pointer _pointer _pointer _pointer _int -> _pointer))

  #| Releases histogram |#
  (defimgproc cvReleaseHist
    (_fun _pointer -> _void))

  #| Clears all the histogram bins |#
  (defimgproc cvClearHist
    (_fun _pointer -> _void))

  #| Finds indices and values of minimum and maximum histogram bins |#
  (defimgproc cvGetMinMaxHistValue
    (_fun _pointer _pointer _pointer _pointer _pointer -> _void))


  #| Normalizes histogram by dividing all bins by sum of the bins, multiplied by <factor>.
  After that sum of histogram bins is equal to <factor> |#
  (defimgproc cvNormalizeHist
    (_fun _pointer _double -> _void))


  #| Clear all histogram bins that are below the threshold |#
  (defimgproc cvThreshHist
    (_fun _pointer _double -> _void))


  #| Compares two histogram |#
  (defimgproc cvCompareHist
    (_fun _pointer _pointer _int -> _double))

  #| Copies one histogram to another. Destination histogram is created if
  the destination pointer is NULL |#
  (defimgproc cvCopyHist
    (_fun _pointer _pointer -> _void))


  #| Calculates bayesian probabilistic histograms
  (each or src and dst is an array of <number> histograms |#
  (defimgproc cvCalcBayesianProb
    (_fun _pointer _int _pointer -> _void))

  #| Calculates array histogram |#
  (defimgproc cvCalcArrHist
  ...
  (defimgproc cvCalcArrBackProject
    (_fun _pointer _pointer _pointer -> _void))
  ...
  (defimgproc cvCalcArrBackProjectPatch
  ...
  *                                  Feature detection                      *
  ...
  ;; Not available in version 2.4.0
  ;; (defimgproc cvLSHRemove
  ;;   (_fun _pointer _pointer -> _void))

  #| Query the LSH n times for at most k nearest points; data is n x d,
  indices and dist are n x k. At most emax stored points will be accessed. |#
  ;; Not available in version 2.4.0
  ;; (defimgproc cvLSHQuery
  ;;   (_fun _pointer _pointer _pointer _pointer _int  _int -> _void))
