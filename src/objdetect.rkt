...
;;; Libraries
  ...
  (define-ffi-definer define-opencv-objdetect
    (ffi-lib "/opt/local/lib/libopencv_objdetect"))
  ...
  ********************************************************************************|#
  ...
  (define-cstruct _CvHaarClassifier
    ([count _int]
     [haar_feature (_cpointer _CvHaarFeature)]
  ...
  (define-cstruct _CvHaarClassifierCascade
    ([flags _int]
     ...
     [scale _double]
     [stage_classifier (_cpointer _CvHaarStageClassifier)]
     [hid_cascade (_cpointer _CvHaarClassifierCascade)]))
  ...
  (define-opencv-objdetect cvLoadHaarClassifierCascade
    (_fun _path _CvSize -> (classifier : (_ptr io _CvHaarClassifierCascade))
